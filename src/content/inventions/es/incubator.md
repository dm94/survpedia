...
Una incubadora es un recinto protegido y cálido que ayuda a mantener la temperatura segura de un recién nacido, sobre todo si es prematuro, débil o está expuesto al frío.

## Uso / Función

- **Estabilidad térmica**: Mantener al bebé en un rango seguro de temperatura.
- **Protección**: Reducir exposición a corrientes, suciedad y manipulación excesiva.
- **Observación**: Permitir revisiones frecuentes sin perder calor.
- **Escala**: Cuidado individual en casa o clínicas pequeñas.

## Principio de funcionamiento

- **Aislamiento**: Un cajón cerrado reduce la pérdida de calor al limitar el flujo de aire.
- **Fuente de calor suave**: Agua tibia o cerámica caliente aportan calor estable.
- **Control de humedad**: Un entorno ligeramente húmedo reduce la deshidratación y el enfriamiento.
- **Vigilancia**: Revisiones frecuentes evitan el sobrecalentamiento.
...
- **Caja de doble pared**: La cámara de aire mejora el aislamiento.
- **Bandeja de agua tibia**: Calor más suave bajo la base.
- **Ventana con malla**: Ventilación sin corrientes fuertes.
- **Incubadora moderna**: Termostato y control de oxígeno.

## Límites y riesgos

- **Sobrecalentamiento**: El exceso de calor puede deshidratar o dañar al recién nacido.
- **Estrés por frío**: Aislamiento pobre o calor insuficiente bajan la temperatura.
- **Riesgo de incendio**: Carbón o cerámica caliente puede encender telas si está muy cerca.
- **Contaminación**: Telas o recipientes sucios elevan el riesgo de infección.
