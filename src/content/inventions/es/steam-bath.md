...
Un baño de vapor es un recinto calentado que se llena de calor húmedo para limpiar el cuerpo, relajar músculos y apoyar la recuperación. Puede ser tan simple como una tienda sobre piedras calientes o tan complejo como una sala de mampostería con una fuente de calor dedicada.

## Uso / Función

- **Higiene:** Limpieza profunda mediante calor y sudor.
- **Recuperación:** Alivia dolor muscular y rigidez articular.
- **Alivio respiratorio:** El calor húmedo puede reducir la congestión.
- **Ritual / social:** Baño comunitario y prácticas de salud.
- **Escala:** Individual a comunitaria.

## Principio de funcionamiento

1. **Almacenamiento de calor:** Las piedras o la mampostería absorben calor del fuego.
2. **Generación de vapor:** Se vierte agua sobre la masa caliente y se evapora rápidamente.
3. **Humedad + calor:** La alta humedad reduce el enfriamiento por evaporación en la piel y el calor se siente más intenso a menor temperatura.
4. **Control de ventilación:** Flujo de aire limitado para retener vapor y permitir intercambio seguro.
...
- **Estrés térmico:** Riesgo de deshidratación, mareo o desmayo.
- **Quemaduras:** Las piedras y el vapor pueden escaldar.
- **Humo:** Si el fuego no está separado, hay riesgo de inhalación.
- **Higiene:** La humedad favorece moho si no se seca y ventila.
- **Daño estructural:** El choque térmico puede agrietar piedra o mampostería.
