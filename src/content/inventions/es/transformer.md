...
materialsUsed:
  ...
  - iron
  - steel
image: ../../../assets/images/inventions/transformer.jpg
---
...
1.  **Construcción del núcleo:** Crear un bucle cerrado o forma de "O" de **[Hierro](/es/materials/iron)**. Para mayor eficiencia, use láminas delgadas y aisladas de **[Acero](/es/materials/steel)** (laminaciones) apiladas para reducir la pérdida de energía por corrientes de Foucault.
2.  **Devanado primario:** Enrolle cable de **[Cobre](/es/materials/copper)** aislado alrededor de un lado del núcleo.
...
- **Bobinas conductoras:** Cable de **[Cobre](/es/materials/copper)** aislado (lo mejor) o **[Aluminio](/es/materials/aluminum)**.
- **Núcleo:** **[Hierro](/es/materials/iron)** o **[Acero](/es/materials/steel)** al silicio.
- **Aislamiento:** **[Papel](/es/materials/paper)**, **[Aceite](/es/materials/crude-oil)** o **[Barniz](/es/materials/resin)** para evitar cortocircuitos.
- **Estructura:** Marco de **[Madera](/es/materials/wood)** o metal para sostener el conjunto.
...
- **[Electricidad](/es/knowledge/electricity)**
- **[Óptica](/es/knowledge/optics)** (por los principios de los campos, aunque de forma menos directa)
