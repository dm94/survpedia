...
- **Torno de pie:** El alfarero patea un volante pesado a sus pies para mantener el impulso. Permite tener ambas manos libres.
- **Torno de pedal:** Utiliza un movimiento recíproco (como una máquina de coser) convertido en rotación.
- **Torno eléctrico:** Utiliza un motor eléctrico para una velocidad y par constantes.
