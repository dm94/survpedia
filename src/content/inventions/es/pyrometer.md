...
materialsUsed:
  ...
  - arcilla
  - glass
image: ../../../assets/images/inventions/pyrometer.jpg
---
...
1. **Pirómetro termoeléctrico (Termopar):**
...
2. **Pirómetro óptico o de radiación:**
...
3. **Conos pirométricos (Conos Seger):**
...
1. Selección de conductores: Obtener dos alambres de metales o aleaciones diferentes (por ejemplo, hierro y constantán, o cobre y níquel).
2. Formación de la unión: Trenzar firmemente o soldar por arco los extremos de ambos alambres para formar la unión caliente.
3. Aislamiento eléctrico: Enhebrar cuentas de cerámica o tubos de vidrio refractario en cada alambre para evitar cortocircuitos a lo largo de su longitud.
4. Unión de referencia: Conectar los extremos libres (unión fría) a un milivoltímetro o galvanómetro sensible situado a temperatura ambiente.
5. Calibración: Calibrar frente a puntos de fusión conocidos de metales puros (por ejemplo, zinc puro a 419,5 °C, aluminio a 660,3 °C o oro a 1064 °C).
