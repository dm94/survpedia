...
La vela es una fuente de luz portátil que consiste en una mecha incrustada en un bloque de combustible sólido (cera o grasa) que se derrite lentamente al arder.

## Uso / Función

- **Uso primario**: Iluminación portátil e independiente.
- **Usos secundarios**: Medición del tiempo (relojes de vela), rituales, sellado con cera.
- **Escala**: Doméstica y personal.

## Principio de funcionamiento

El calor de la llama de la mecha derrite el combustible sólido justo debajo de ella. Este combustible líquido es absorbido por la mecha (capilaridad), sube hasta la llama y se vaporiza para arder. A medida que el combustible se consume, la vela se acorta.
...
- **Vela de Sebo**: Barata y común, pero humea y huele mal.
- **Vela de Cera de Abejas**: Lujosa, olor agradable, llama brillante y limpia.
- **Vela de Junco**: Un junco pelado empapado en grasa (versión muy pobre y rápida).

## Límites y riesgos

- **Calor**: Se derriten si hace mucho calor (especialmente el sebo).
- **Incendio**: Llama abierta sin protección.
- **Seguridad**: Nunca dejar desatendida.
