...
1.  **Peso (Gravedad):** Objetos pesados simples (piedras, bloques de hormigón) que dependen de la fricción y la masa para sujetarse al fondo. Efectivo para botes pequeños o en fondos duros.
2.  **Enganche (Forma):** El ancla está diseñada para clavarse en el fondo marino. A medida que el barco tira, las uñas (puntas) se entierran más profundamente. Esto es mucho más eficiente que el peso puro.

**El Efecto Catenaria:**
Crucial para el anclaje es la línea de fondeo (cuerda o cadena). Una cadena pesada forma una curva (catenaria). El peso de la cadena mantiene el tirón sobre el ancla horizontal, lo que ayuda a que se clave. Si el tirón es vertical, el ancla se suelta (garrea).
