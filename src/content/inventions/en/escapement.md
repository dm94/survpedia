...
2.  **Pallets:** Fabricate the locking components (pallets). In high-quality watches, these are made of synthetic **[Ruby](/en/materials/ruby)** to reduce friction. In clocks, hardened **[Steel](/en/materials/steel)** is common.
...
-   **Escape Wheel:** **[Brass](/en/materials/brass)** (work-hardened) or **[Steel](/en/materials/steel)**.
-   **Pallets:** Hardened **[Steel](/en/materials/steel)** or **[Ruby](/en/materials/ruby)** (Jewels).
-   **Arbors:** Polished **[Steel](/en/materials/steel)** for low-friction pivoting.

## Variants and improvements

-   **Verge Escapement:** The earliest type, used with a foliot. High friction, low accuracy.
-   **Anchor Escapement:** Used in **[Pendulum Clocks](/en/inventions/pendulum-clock)**. Allows for a smaller pendulum swing and better accuracy.
-   **Deadbeat Escapement:** An improvement on the anchor that eliminates recoil, providing higher precision.
-   **Lever Escapement:** The standard for **[Mechanical Watches](/en/inventions/mechanical-watch)**. It is detached, meaning it only touches the balance wheel briefly, improving accuracy.
