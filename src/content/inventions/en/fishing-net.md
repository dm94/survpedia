...
1. **Make twine**: Twist **[Plant fibers](/en/materials/plant-fibers)** into thin cord.
2. **Knot the mesh**: Use a netting needle and spacer to tie consistent squares.
3. **Add floats**: Lash **[Cork](/en/materials/cork)** or carved **[Wood](/en/materials/wood)** to the top line.
4. **Add sinkers**: Tie **[Stone](/en/materials/stone)** along the bottom line.
5. **Inspect and repair**: Replace broken knots before each use.
