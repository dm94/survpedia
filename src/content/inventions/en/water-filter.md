...
- **Adsorption:** **[Charcoal](/en/materials/charcoal)** (activated carbon) absorbs chemicals, odors, and toxins.
...
2.  **Drainage Layer:** Place a layer of clean **[gravel](/en/materials/gravel)** at the bottom to cover the outlet.
3.  **Separation:** Place a mesh or **[fabric](/en/materials/fabric)** over the gravel to prevent mixing.
4.  **Filtration Layer:** Fill the bulk of the container with fine, washed **[sand](/en/materials/sand)**.
5.  **Adsorption Layer (Optional):** Add a layer of crushed **[charcoal](/en/materials/charcoal)** for chemical purification.
6.  **Operation:** Pour water slowly. The first few liters should be discarded until the water runs clear.

## Materials needed

- **Filtering Media:** **[Sand](/en/materials/sand)**, **[Gravel](/en/materials/gravel)**, **[Charcoal](/en/materials/charcoal)**.
- **Housing:** **[Container](/en/inventions/containers)** (plastic, ceramic, wood).
- **Separators:** **[Fabric](/en/materials/fabric)** or fine mesh.
...
- **[Charcoal](/en/materials/charcoal):** Key ingredient for adsorption.
- **[Distillation](/en/inventions/distillation):** Alternative for high purity.
- **[Water Supply](/en/inventions/water-supply):** System context.
