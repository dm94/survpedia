...
1.  **Stock**: Start with two steel bars (e.g., rebar or square stock).
2.  **Jaws**: Flatten and shape one end of each bar to form the gripping surface (bit).
3.  **Boss**: Upset (thicken) and flatten the area behind the jaw to create a flat spot for the pivot. Punch or drill a hole here.
4.  **Reins**: Draw out (thin and lengthen) the rest of the bar to form the handles.
5.  **Assembly**: Place the two halves together (crossing them) and insert a rivet (metal pin) through the holes. Hammer the rivet heads flat while hot to lock them, but leave it loose enough to move.

## Materials needed

- **Essential**:
  - **Metal**: **[Iron](/en/materials/iron)** or **[Mild Steel](/en/materials/steel)**. High carbon steel is not necessary and can be brittle if cooled rapidly in water during use.
- **Tools**: **[Forge](/en/inventions/forge)**, **[Hammer](/en/inventions/hammer)**, **[Anvil](/en/inventions/anvil)**.
