...
2.  **Vertical Transfer:** The vertical supports carry the load down to the **[Foundation](/en/inventions/foundation)**.
3.  **Rigidity:** The frame must resist deformation from lateral forces (wind, earthquakes) using bracing or shear walls. Triangulation (as in a **[Truss](/en/inventions/truss)**) is often used for stability.
...
5.  **Assembly (Roof):**
    - **Rafters/Trusses:** Install the roof frame on top of the walls to support the **[Roofing](/en/inventions/roofing)**.
...
- **Structural Members:**
  - **[Wood](/en/materials/wood):** Lumber, timber, or engineered wood.
  - **[Steel](/en/materials/steel):** Beams, columns, or light gauge studs.
  - **[Concrete](/en/materials/concrete):** Reinforced columns and beams.
- **Fasteners:** Nails, screws, bolts, plates, or welding (for metal).
- **Tools:** **[Hammer](/en/inventions/hammer)**, **[Saw](/en/inventions/saw)**, **[Level](/en/inventions/level)**, **[Drill](/en/inventions/hand-drill)**.
...
- **[Truss](/en/inventions/truss):** A triangulated frame component used for long spans.
