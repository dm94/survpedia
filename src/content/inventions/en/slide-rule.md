...
1.  **Logarithmic Scales:** The scales on a slide rule are not linear but logarithmic.
2.  **Addition for Multiplication:** Because $\log(A \times B) = \log(A) + \log(B)$, the physical addition of two lengths on logarithmic scales corresponds to the multiplication of the numbers they represent.
3.  **Subtraction for Division:** Similarly, subtracting lengths corresponds to division.
4.  **Analog Nature:** It provides a visual, analog representation of numerical relationships.

## How to create it

### 1. The Body (Stock)
Create a stable frame with a central groove. Typically made of dimensionally stable **[Wood](/en/materials/wood)** (like boxwood), **[Aluminum](/en/materials/aluminum)**, or high-quality plastic.
...
- **[Wood](/en/materials/wood)**: Specifically boxwood or mahogany for stability.
- **[Aluminum](/en/materials/aluminum)**: For more durable, modern versions.
- **[Ivory](/en/materials/bone)** or Bone: Historically used for the scales face.
- **Plastic:** For low-cost mass production.
- **[Glass](/en/materials/glass)**: For the cursor window.
...
- **[Mathematics](/en/knowledge/mathematics)**
- **[Compass](/en/inventions/drawing-compass)**
