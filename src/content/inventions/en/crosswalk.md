...
1.  **Selection:** Choose a location with good visibility for both pedestrians and drivers.
2.  **Cleaning:** Clean the road surface to ensure paint adhesion.
3.  **Marking:** Paint parallel white stripes (about 40-60 cm wide) across the road width.
4.  **Signage:** Add vertical signs to warn approaching drivers.

### Raised Crosswalk (Speed Table)

1.  **Forming:** Build a flat-topped hump across the road using [asphalt](/en/materials/asphalt) or [concrete](/en/materials/concrete).
2.  **Ramping:** Create gentle ramps on both sides for vehicles to ascend and descend.
3.  **Surfacing:** Mark the top surface with [paint](/en/materials/paint) or different colored [stones](/en/materials/stone).

## Materials needed

- **Essential:** [Paint](/en/materials/paint) (durable road marking paint), [Stone](/en/materials/stone) (for cobblestone crossings).
- **Construction:** [Asphalt](/en/materials/asphalt) or [Concrete](/en/materials/concrete) (for raised versions).
...
- **[Road](/en/inventions/road):** The infrastructure it modifies.
- **[Concrete](/en/materials/concrete):** Material for construction.
- **[Paint](/en/materials/paint):** Essential for marking.
