...
2.  **Gear Train:** A series of **[Gears](/en/inventions/gears)** that transmits energy from the power source to the escapement and counts the oscillations to drive the hands.
...
4.  **Oscillator:** A physical object that swings back and forth at a constant frequency (isochronism), such as a **[Pendulum](/en/inventions/pendulum-clock)** or a **[Balance Wheel](/en/inventions/balance-wheel)**.
...
- **Essential:** **[Metal](/en/materials/metal)** (Brass for gears to reduce friction, Steel for pinions and springs) is preferred. Hard **[Wood](/en/materials/wood)** can be used for large tower clocks or rustic movements.
- **Weights:** **[Lead](/en/materials/lead)**, **[Iron](/en/materials/iron)**, or **[Stone](/en/materials/stone)**.
- **Lubrication:** Fine **[Oil](/en/materials/oil)** (historically from animal fat or plants) is crucial to prevent wear.

## Variants and improvements

- **Verge and Foliot:** The earliest mechanical escapement, less accurate.
- **Pendulum Clock:** Uses a swinging weight for high accuracy (**[Pendulum Clock](/en/inventions/pendulum-clock)**).
- **Balance Wheel:** Uses a spring-regulated wheel, allowing portability (**[Mechanical Watch](/en/inventions/mechanical-watch)**).
