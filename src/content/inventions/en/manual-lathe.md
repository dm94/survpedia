...
1.  **Frame:** Build a sturdy wooden bed with two uprights.
2.  **Points:** Insert metal spikes (centers) into the uprights to hold the wood. One must be adjustable.
3.  **Power:** Attach a flexible sapling or pole above the lathe. Tie a rope to the tip, wrap it around the workpiece, and tie the other end to a foot treadle.
4.  **Action:** Pressing the treadle spins the wood (cutting stroke); the spring pole pulls it back (return stroke).

### Bow Lathe (Portable)

1.  Similar setup but powered by moving a bow back and forth, wrapping the string around the workpiece.

### Flywheel Lathe (Continuous)

1.  Uses a heavy flywheel and a crank or treadle mechanism to maintain continuous rotation and momentum.
