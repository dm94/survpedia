...
1.  **Electrical input**: A varying electric current (representing sound) flows through a coil of **[Wire](/en/materials/wire)**.
2.  **Magnetic interaction**: This current creates a varying magnetic field around the coil, which interacts with the fixed magnetic field of a permanent **[Magnet](/en/inventions/magnet)**.
3.  **Mechanical movement**: The interaction causes the coil (the voice coil) to move back and forth rapidly.
4.  **Acoustic output**: The coil is attached to a large diaphragm or cone (usually made of **[Paper](/en/materials/paper)**). As the coil moves, it vibrates the cone, pushing the air and creating sound waves.

## How to create it

### Minimum functional version

1.  **Magnet**: A strong permanent **[Magnet](/en/inventions/magnet)**.
2.  **Voice Coil**: A cylinder of lightweight material with many turns of thin insulated **[Copper](/en/materials/copper)** **[Wire](/en/materials/wire)**.
3.  **Cone**: A stiff but lightweight cone made of **[Paper](/en/materials/paper)** or thin plastic.
...
5.  **Assembly**: The voice coil is glued to the center of the cone and positioned so it surrounds (but does not touch) the magnet. The cone is mounted in a **[Wood](/en/materials/wood)** or metal frame.
...
- **Essential materials**:
  - **[Magnet](/en/inventions/magnet)**: Powerful permanent magnet.
  - **[Wire](/en/materials/wire)**: Enameled **[Copper](/en/materials/copper)** wire.
  - **Cone**: Stiff **[Paper](/en/materials/paper)** or cardstock.
  - **Adhesive**: Strong, lightweight **[Glue](/en/materials/glue)**.
- **Tools**:
