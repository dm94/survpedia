...
1.  **Bag**: Use a whole animal skin (goat/sheep) or sew a leather bag.
2.  **Nozzle**: Attach a pipe (wood/bamboo/clay) to one leg or a specific opening.
3.  **Operation**: Lift the bag to fill with air (open top), then close and press down to expel air.
...
1.  **Box**: Build a rectangular wooden box.
2.  **Piston**: Create a tight-fitting plunger wrapped in fur or feathers (to seal against the walls).
3.  **Valves**: Use flap valves to direct airflow.
4.  **Efficiency**: Often double-acting (pumps air on both push and pull strokes), providing a constant blast.

## Materials needed

- **Essential**:
  - **Chamber**: **[Wood](/en/materials/wood)** or **[Leather](/en/materials/leather)**.
  - **Nozzle**: Metal pipe or fire-hardened clay to resist the heat near the fire.
  - **Seal**: Fat/Grease to keep leather flexible and airtight.
