...
1. **Assess ground**: Identify soft zones, fractures, and moisture.
2. **Choose the system**: Timber posts, A-frames, plank timbering, or stone lining.
3. **Prepare bases**: Level contact points and place wedges for tight bearing.
4. **Install supports**: Set posts and caps from the entrance toward the working face.
5. **Line the walls**: Add boards or stone to contain loose material.
6. **Technical level**: Basic for timber posts, intermediate for timbered drifts, advanced for metal sets.

## Materials needed

- **Essential**: **[Wood](/en/materials/wood)** for posts and frames, **[Stone](/en/materials/stone)** or **[Clay](/en/materials/clay)** for lining, **[Iron](/en/materials/iron)** or **[Steel](/en/materials/steel)** for clamps and bracing.
- **Tools**: Hammer, saw, chisel, wedges, cordage or fiber lashings.
- **Substitutes**: Compacted earth, dry-stacked stone walls, **[Plant fibers](/en/materials/plant-fibers)** for lashings.
