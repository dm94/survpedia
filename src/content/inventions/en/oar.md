...
1. **Selection:** Select a straight, strong, and flexible piece of wood (like ash or spruce).
2. **Shaping:** Carve the handle at one end and flatten the other end into a blade.
3. **Balancing:** Ensure the oar is balanced so that the blade doesn't feel too heavy when pivoted at the oarlock.
4. **Smoothing:** Sand the handle to prevent blisters and the shaft to reduce friction.
