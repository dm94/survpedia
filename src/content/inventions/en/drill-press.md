...
1.  **Frame:** A sturdy wooden or metal post bolted to a wall or bench.
2.  **Spindle:** A vertical shaft with a hand crank or flywheel for momentum.
3.  **Feed:** A screw mechanism to advance the bit as it turns (automatic feed) or a simple lever.

### Intermediate version (Belt Driven)

1.  **Column:** A rigid steel pipe or cast iron column.
2.  **Head:** Contains the spindle bearings and quill assembly.
3.  **Drive:** A system of stepped pulleys to allow different speeds (slow for metal, fast for wood).
4.  **Table:** Can be raised, lowered, and swiveled around the column.
...
- **Tools:** **[Lathe](/en/inventions/lathe)** (for the spindle), **[Files](/en/inventions/file)**, **[Drill Bit](/en/inventions/drill-bit)**.
