...
1.  **[Lever](/en/inventions/lever):** A rigid bar resting on a pivot (fulcrum), used to help move a heavy or firmly fixed load with one end when pressure is applied to the other.
2.  **[Wheel and Axle](/en/inventions/wheel):** A wheel attached to a smaller axle so that these two parts rotate together in which a force is transferred from one to the other.
3.  **[Pulley](/en/inventions/pulley):** A wheel on an axle or shaft that is designed to support movement and change of direction of a taut cable or belt.
4.  **[Inclined Plane](/en/inventions/inclined-plane):** A flat supporting surface tilted at an angle, with one end higher than the other, used as an aid for raising or lowering a load.
5.  **[Wedge](/en/inventions/wedge):** A triangular shaped tool, and is a portable inclined plane, and one of the six classical simple machines. It can be used to separate two objects or portions of an object, lift up an object, or hold an object in place.
6.  **[Screw](/en/inventions/screw):** A mechanism that converts rotational motion to linear motion, and a torque (rotational force) to a linear force.
...
- **Structural:** [Wood](/en/materials/wood), [Stone](/en/materials/stone), [Iron](/en/materials/iron), [Steel](/en/materials/steel).
- **Fasteners:** [Rope](/en/materials/rope), [Nails](/en/materials/nail), pegs.
