...
1.  **Races:** Create two rings (inner and outer) from hardened **[Steel](/en/materials/steel)**. Machine grooves (raceways) into them to guide the rolling elements.
2.  **Rolling Elements:** Manufacture perfectly spherical balls or cylindrical rollers from hardened steel. They must be extremely smooth and uniform in size.
3.  **Cage (Retainer):** Fabricate a cage (often from **[Brass](/en/materials/brass)** or stamped steel) to keep the balls/rollers evenly spaced and prevent them from rubbing against each other.
4.  **Assembly:** Place the balls between the races, install the cage, and seal or shield the bearing if necessary.
5.  **Lubrication:** Apply **[Animal Fat](/en/materials/animal-fat)** or **[Vegetable Oil](/en/materials/vegetable-oil)** to reduce wear and heat.
...
- **Essential Materials:**
  - **[Steel](/en/materials/steel):** High-carbon or alloy steel for races and rolling elements (must be hardenable).
  - **[Brass](/en/materials/brass)** or **[Bronze](/en/materials/bronze):** For the cage (retainer).
  - **[Animal Fat](/en/materials/animal-fat)** or **[Vegetable Oil](/en/materials/vegetable-oil):** For lubrication.
- **Tools:**
  - **[Lathe](/en/inventions/lathe):** For machining the races.
  - **Grinder:** For finishing the hardened surfaces (using **[Grinding Wheel](/en/inventions/grinding-wheel)**).
  - **[Furnace](/en/inventions/furnace):** For heat treating the steel.
