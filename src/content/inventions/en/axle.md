...
An axle is a central shaft for a rotating [wheel](/en/inventions/wheel) or gear. On wheeled vehicles, the axle may be fixed to the wheels, rotating with them, or fixed to the vehicle, with the wheels rotating around the axle.
...
1.  **Selection:** Choose a straight, strong branch or trunk of hardwood (e.g., oak, hickory).
2.  **Shaping:** Carve it into a perfect cylinder. The ends must be particularly smooth and uniform to fit the wheel hubs.
3.  **Smoothing:** Sand or polish the surface to minimize friction.
4.  **Fitting:** Ensure it fits tightly into the vehicle frame (for dead axles) or wheel hubs (for live axles).

### Metal Axle

1.  **Forging/Casting:** Create a metal rod of uniform thickness.
2.  **Machining:** Use a lathe to ensure perfect cylindrical shape and smooth surface.
