...
1.  **Runners:** Select two long, sturdy poles or planks. If using wood, they can be steam-bent at the front to glide over obstacles.
2.  **Shoeing (Optional):** Attach bone, antler, or a layer of frozen mud/ice to the bottom of the runners to reduce friction and protect the wood.
3.  **Crossbars:** Lay wooden crosspieces across the runners.
4.  **Lashing:** Lash the crossbars to the runners using [rope](/en/inventions/rope) or raw hide. Do _not_ use rigid joinery (nails/screws) if traversing rough terrain; flexibility is key.
5.  **Decking:** Add a platform of slats or hide on top of the crossbars to hold the load.
