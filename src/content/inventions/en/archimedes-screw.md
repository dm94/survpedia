...
1.  **Core:** Start with a sturdy wooden log as the central [axle](/en/inventions/axle).
2.  **Vanes:** Construct the spiral vanes.
    - **Method A (Carved):** Carve the spiral from a single thick log (difficult).
    - **Method B (Built-up):** Attach thin flexible boards or shaped wooden pieces to the axle to form the helix. Use [glue](/en/materials/glue) and [nails](/en/materials/nail).
3.  **Casing:**
    - **Option 1 (Fixed):** The screw rotates inside a stationary trough or pipe. The fit must be tight to minimize backflow.
    - **Option 2 (Rotating):** The casing is attached to the screw and rotates with it. This is easier to seal (using [pitch](/en/materials/pitch) or [tar](/en/materials/tar)) but heavier to turn.
4.  **Mounting:** Install it at an angle (usually 30° to 45°).

## Materials needed

- **Structure:** [Wood](/en/materials/wood) is the traditional material.
- **Sealing:** [Pitch](/en/materials/pitch), [Tar](/en/materials/tar), or [Beeswax](/en/materials/beeswax) to make the casing watertight.
- **Fasteners:** [Iron](/en/materials/iron) or [Bronze](/en/materials/bronze) nails/staples.
- **Bearings:** Simple [Slide Bearings](/en/inventions/slide-bearings) for the axle ends.
