...
1.  **Dig a Pit**: Dig a small hole in the ground (about 30cm wide and 15cm deep).
2.  **Air Supply**: Dig a trench or insert a pipe (clay, bamboo, or metal) leading to the bottom side of the pit. This is the **tuyere**.
3.  **Lining**: Line the pit with clay or mud to prevent the earth from crumbling and to reflect heat.
4.  **Bellows**: Connect a bellows (made of leather bags or wood) to the pipe to pump air.

### Raised Forge (Permanent)

1.  **Structure**: Build a waist-high table from stone or brick.
2.  **Firepot**: Create a depression in the center lined with fire-resistant clay or cast iron.
3.  **Air System**: Install a tuyere at the bottom of the firepot, connected to a hand-cranked blower or large bellows.
4.  **Hood (Optional)**: Build a chimney or hood above to carry away smoke.

## Materials needed

- **Essential**:
  - **Refractory Material**: Clay, stone, or firebrick that can withstand high heat without cracking or melting.
  - **Air Pipe (Tuyere)**: Iron pipe is best, but clay or even hollow wood (kept wet/cool) can work in a pinch.
  - **Fuel**: **[Charcoal](/en/materials/charcoal)** or **[Coal](/en/materials/coal)**.
- **Tools**: Shovel, Trowel.
