...
1.  **Selection**: Find a large, dense, fine-grained stone (like granite or basalt) with a flat top surface.
2.  **Mounting**: Bury it partially in the ground or mount it on a sturdy log stump to bring it to working height (knuckle height when standing).

### Forged/Cast Iron Anvil

1.  **Body**: In early times, anvils were often wrought iron blocks.
2.  **Face**: A plate of high-carbon steel is forge-welded to the top surface.
3.  **Hardening**: The steel face is heated and quenched to make it extremely hard, while the body remains tough and ductile to absorb shock without cracking.
4.  **Modern**: Most modern anvils are cast steel or cast iron with a chilled (hardened) face.

## Materials needed

- **Essential**:
  - **Mass**: The heavier the better (typically 50kg+ for serious work).
  - **Hard Material**: **[Stone](/en/materials/stone)**, **[Iron](/en/materials/iron)**, or **[Steel](/en/materials/steel)**.
