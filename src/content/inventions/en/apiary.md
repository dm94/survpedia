...
An apiary is a managed site where multiple bee hives are placed, protected, and maintained for efficient **[Beekeeping](/en/knowledge/beekeeping)**.
...
- **Resource proximity**: Nearby **[Water](/en/materials/water)** and forage reduce stress.

## How to create it

1. **Choose the site**: Pick a sunny, well-drained area with windbreaks and clean **[Water](/en/materials/water)** nearby.
2. **Lay out rows**: Mark hive positions with clear approach paths and enough spacing for work.
3. **Build stands**: Use level **[Wood](/en/materials/wood)** frames or **[Stone](/en/materials/stone)** pads to keep hives off damp ground.
4. **Add barriers**: Install fences or screens woven from **[Plant fibers](/en/materials/plant-fibers)** to guide bee flight upward.
5. **Protect and label**: Seal joints with **[Resin](/en/materials/resin)** and mark hives for tracking.
6. **Operate**: Use **[Controlled Fire](/en/inventions/fire)** smoke sparingly and **[Containers](/en/inventions/containers)** for harvests.
...
- **Essential**: **[Wood](/en/materials/wood)** for stands and hive supports, **[Stone](/en/materials/stone)** or compacted earth for stable pads, **[Plant fibers](/en/materials/plant-fibers)** for screens.
- **Tools**: Cutting tools, mallet, measuring cord, **[Containers](/en/inventions/containers)** for honey handling.
