...
1. **The Loop**: A simple loop of heavy leather or a wooden frame shaped like a "D" or triangle.
2. **The Attachment**: A strong leather strap (stirrup leather) that connects the loop to the saddle's tree (the internal frame).
3. **The Base**: A flat bottom to prevent the foot from slipping through.
...
- **Essential**: **[Leather](/en/materials/leather)** (for straps and basic loops), **[Iron](/en/materials/iron)** or **[Bronze](/en/materials/bronze)** (for durable rings), **[Wood](/en/materials/wood)** (for frames).
- **Tools**: **[Hammer](/en/inventions/hammer)**, **[Anvil](/en/inventions/anvil)**, **[Knife](/en/inventions/knife)**, **[Awl](/en/inventions/awl)** for leather work.
- **Substitutes**: Strong **[Rope](/en/materials/rope)** can be used for temporary stirrups, though it is less stable.
