...
Unlike an **[Arch](/en/inventions/arch)** which relies entirely on compression to span a gap, the cable-stayed bridge relies on the high tensile strength of steel cables.

## How to create it

1.  **[Foundations](/en/inventions/foundation)**: Build strong foundations for the towers (pylons) and the anchorages at the ends of the deck.
...
- **Essential**:
  - **[Steel Cable](/en/materials/steel-cable)**: High-strength strands are critical.
  - **[Concrete](/en/materials/concrete)**: For towers and deck.
  - **[Steel](/en/materials/steel)**: For reinforcement, towers, or deck structure.
