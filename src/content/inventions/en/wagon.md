...
A wagon is a four-wheeled vehicle designed for transporting heavy loads, typically pulled by draft animals (horses, oxen, mules). Unlike a [cart](/en/inventions/cart), which has two wheels, a wagon is self-supporting and stable when stationary, allowing for much larger capacities.
...
- **Steering:** To turn, the front [axle](/en/inventions/axle) must be able to pivot relative to the frame. This requires a "fifth wheel" or a pivot pin mechanism.
- **Rolling Resistance:** Like the cart, [wheels](/en/inventions/wheel) reduce friction compared to dragging.
