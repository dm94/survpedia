...
1.  **Forging**: Create two identical metal pieces, each with a handle side, a jaw side, and a hole for the pivot.
2.  **Assembly**: Align the pivot holes and insert a rivet or bolt.
3.  **Finishing**: Ensure the jaws meet flush when closed.
