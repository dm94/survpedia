...
1.  **Weight (Gravity)**: Simple heavy objects (**[Stone](/en/materials/stone)**, concrete blocks) that rely on friction and mass to hold onto the bottom. Effective for small boats or on hard bottoms.
2.  **Hooking (Shape)**: The anchor is designed to dig into the seabed. As the ship pulls, the flukes (points) bury themselves deeper. This is much more efficient than pure weight.

**The Catenary Effect:**
Crucial for anchoring is the anchor line (rope or chain). A heavy chain forms a curve (catenary). The weight of the chain keeps the pull on the anchor horizontal, helping it stay dug in. If the pull is vertical, the anchor breaks free.
...
- **[Stone](/en/materials/stone)**: The simplest weight.
- **[Wood](/en/materials/wood)**: For stocks or primitive hook structures.
- **[Iron](/en/materials/iron)**: For strong, thin shanks and flukes that can penetrate sand/mud.
- **[Lead](/en/materials/lead)**: Historically used for stocks to add weight in a compact form.
- **[Rope](/en/materials/rope)** / Chain: Essential for connecting the anchor to the boat.
