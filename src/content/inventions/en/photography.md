...
Photography relies on two main components: the **[Camera Obscura](/en/inventions/camera-obscura)** (a dark chamber that projects an image) and a **light-sensitive chemical reaction**.

1.  **Projection**: Light from a scene passes through a small hole or **[Lens](/en/inventions/lens)**, projecting an inverted image onto a surface.
...
4.  **Fixing**: A "fixer" chemical (like **[Salt](/en/materials/salt)** or sodium thiosulfate) removes the unreacted light-sensitive chemicals so the image no longer reacts to light.

## How to create it

### 1. The Camera
Construct a light-tight box. On one side, place a **[Lens](/en/inventions/lens)** (or a simple pinhole). On the opposite side, place a holder for the light-sensitive plate or paper.

### 2. The Light-Sensitive Surface (Daguerreotype-style)
- Take a highly polished **[Silver](/en/materials/silver)**-plated copper sheet.
...
- Fix the image by washing the plate in a strong solution of **[Salt](/en/materials/salt)** or sodium thiosulfate to make it permanent.
