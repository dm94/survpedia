...
_Note: These designs do not work forever, but they are famous attempts._

### The Overbalanced Wheel (Bhaskara's Wheel)

1.  **Wheel:** A large wheel mounted on an [axle](/en/inventions/axle).
2.  **Arms:** Hinged arms or curved tubes attached to the rim.
3.  **Weights:** Heavy weights (or [mercury](/en/elements/mercury)) that swing out on one side and fold in on the other.
...
1.  **Rotor:** A wheel with [magnets](/en/inventions/magnet) angled in one direction.
...
- **Precision Components:** [Ball and Roller Bearings](/en/inventions/ball-and-roller-bearing) to minimize friction (the main enemy).
- **Weights:** [Lead](/en/materials/lead), [Mercury](/en/elements/mercury), or [Iron](/en/materials/iron).
- **Magnets:** [Magnetite](/en/materials/magnetite) or strong artificial [Magnets](/en/inventions/magnet).
