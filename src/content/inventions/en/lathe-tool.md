...
1.  **Forging**: Shape a steel bar.
2.  **Sharpening**: Use files or whetstones to create the cutting angles.
3.  **Tempering**: Harden the tip to resist wear.

### Standard version (High Speed Steel - HSS)

Start with a square HSS bar (cobalt or tungsten) and grind it on a **[Grinding Wheel](/en/inventions/grinding-wheel)** to the desired geometry.

### Advanced version (Carbide)

Braze a small **[Tungsten Carbide](/en/materials/tungsten)** insert onto a steel shank, or use indexable inserts. This allows cutting harder materials at higher speeds.
...
- **Tools**: **[Grinding Wheel](/en/inventions/grinding-wheel)** (essential for shaping and sharpening).
