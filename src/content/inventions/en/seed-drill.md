...
- **Essential materials**:
    - **[Wood](/en/materials/wood)**: For the frame and hopper.
    - **[Iron](/en/materials/iron)**: For the coulter/tip and axle components.
- **Tools**:
    - **[Saw](/en/inventions/saw)**, **[Drill](/en/inventions/hand-drill)**, **[Hammer](/en/inventions/hammer)**.
- **Possible substitutes**:
    - Hardwood coulters (fire-hardened) can substitute for iron in soft soils.
    - **[Bamboo](/en/materials/bamboo)** can be used for seed tubes.
