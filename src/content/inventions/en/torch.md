...
1.  **Holder:** Find a branch of green or hard wood, about 50-70 cm long. Green wood takes longer to burn.
2.  **Head:** Wrap the top end with cloth, old rags, or dry vegetable fibers (like birch bark or rope). Secure it well so it doesn't fall off.
3.  **Fuel:** Generously soak the wrapped head with a flammable but slow-burning material:
    - Pine resin (pitch).
    - Animal fat.
    - Vegetable oil.
    - Natural bitumen.
4.  **Ignition:** Bring the head close to a fire source until it catches.
