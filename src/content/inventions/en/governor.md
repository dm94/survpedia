...
1.  **Centrifugal Force:** As the engine spins faster, weights on the governor spin faster and fly outward due to centrifugal force.
2.  **Mechanical Linkage:** The outward movement of the weights lifts a sleeve or lever.
3.  **Valve Control:** This lever is connected to the steam throttle valve or fuel injection pump.
4.  **Feedback:** If the engine speeds up, the valve closes slightly (reducing power). If it slows down (load increases), the valve opens (increasing power).

## How to create it

### Simple Fly-Ball Governor

1.  **Spindle:** A vertical shaft driven by the engine (via a belt or gears).
2.  **Arms:** Two or more arms pivoted at the top of the spindle.
3.  **Weights (Fly-balls):** Heavy metal balls (usually **[Iron](/en/materials/iron)** or **[Brass](/en/materials/brass)**) attached to the ends of the arms.
4.  **Sleeve:** A collar that slides up and down the spindle, connected to the arms by links.
5.  **Linkage:** A system of rods and levers connecting the sleeve to the engine's throttle valve.

## Materials needed

- **Weights:** Heavy metal (**[Iron](/en/materials/iron)**, **[Brass](/en/materials/brass)**, **[Lead](/en/materials/lead)**).
- **Spindle/Arms:** **[Steel](/en/materials/steel)** or **[Iron](/en/materials/iron)**.
