...
1. **Tree Selection:** Choose a large, straight, rot-resistant tree trunk (e.g., cedar, redwood, or pine).
2. **Felling and Sizing:** Fell the tree and cut it to the desired length.
3. **Hollowing:** Use controlled fire to char the interior wood, then scrape away the burnt material with adzes or stone scrapers. Repeat until hollow.
4. **Shaping:** Hew the exterior to a hydrodynamic shape, tapering the ends.
5. **Finishing:** Smooth the hull and seal it with animal fat, oil, or resin to prevent water absorption.
