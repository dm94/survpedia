...
1.  **Define the Unit:** Determine what constitutes a "day" (sunrise to sunrise, or sunset to sunset).
...
3.  **Count and Record:** Use tally marks (on bone, wood, or stone) to count days between these events.
4.  **Structure:** Group days into larger units (months based on the moon, years based on the sun).
5.  **Correction:** If the seasons start drifting (e.g., winter harvest comes too early), add days or months to realign the system.
