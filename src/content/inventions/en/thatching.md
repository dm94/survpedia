...
Thatching is the craft of building a roof with dry vegetation such as **[Straw](/en/materials/straw)**, water reed, sedge, rushes, heather, or palm branches, layering the vegetation so as to shed water away from the inner roof. It is one of the oldest roofing methods and remains a viable, sustainable technique today.
...
1.  **Preparation:** Harvest the material (reed/straw) during winter when it is dry and dormant. Clean and bundle it.
2.  **Structure:** Build a roof frame with a pitch of at least 45 degrees. Install battens or laths horizontally across the rafters.
3.  **Eaves:** Start at the bottom (eaves). Secure a heavy base layer to project over the wall, ensuring water drips clear of the foundation.
4.  **Layering:** Place bundles (courses) horizontally, working upwards. Each new layer overlaps the one below, covering the fixings.
5.  **Fixing:** Secure each course to the rafters/battens.
...
6.  **Dressing:** Use a tool called a **Leggett** to beat the ends of the straw/reed upwards and inwards, tightening the coat and creating a smooth, even surface.
7.  **Ridging:** The peak (ridge) is the most vulnerable point. It is capped with a flexible material (often sedge or pliable straw) wrapped over the top and secured with decorative spars.
8.  **Netting:** (Optional) Cover with wire mesh to protect against birds and rodents.
...
-   **Fixings:**
    -   **[Wood](/en/materials/wood):** Hazel or willow for spars (staples) and sways (rods).
    -   **[Metal](/en/materials/metal):** Copper or steel wire.
    -   **Cord:** Tarred twine (historically).
-   **Tools:**
...
-   **[Roofing](/en/inventions/roofing):** The general category.
-   **[Basic Shelter](/en/inventions/basic-shelter):** Often uses primitive thatching.
-   **[Chimney](/en/inventions/chimney):** Critical component requiring careful detailing in thatched roofs.
-   **[Needle](/en/inventions/needle):** Large versions used for stitching.

### Related materials

-   **[Straw](/en/materials/straw)**
-   **[Wood](/en/materials/wood)**
-   **[Plant fibers](/en/materials/plant-fibers)**
