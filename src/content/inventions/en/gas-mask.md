...
materialsUsed:
  ...
  - natural-rubber
  - glass
image: ../../../assets/images/inventions/gas-mask.jpg
---
...
2. **Adsorption of Chemical Gases**: Contaminated air passes through a chamber packed with activated **[Charcoal](/en/materials/charcoal)**. Activated charcoal possesses an exceptionally porous micro-structure with a massive internal surface area ($500\text{–}1500\,\text{m}^2/\text{g}$). Non-polar chemical vapours and organic gases adhere to the carbon surface through van der Waals forces (adsorption).
...
2. **Build the Filter Canister**: Take a cylindrical metal or sturdy rigid plastic container. Drill small air inlet holes in the bottom cap. Line the inner bottom with a dense layer of cotton **[Fabric](/en/materials/fabric)** or felt as a particulate pre-filter.
...
4. **Construct the Face Mask**: Shape a flexible rubber hood using **[Natural Rubber](/en/materials/natural-rubber)** or sealed leather that fits tightly around the contours of the mouth, nose, and chin. Cut two eye openings and seal clear **[Glass](/en/materials/glass)** discs over them using waterproof adhesive.
...
_Technical Level_: Intermediate. Requires proper activation of charcoal and meticulous airtight fitting around the face.

## Materials needed

- **Filter Canister**:
  - Activated **[Charcoal](/en/materials/charcoal)** (chemically or thermally activated granules).
  - Dense **[Fabric](/en/materials/fabric)** or felt pads (pre-filter and post-filter layers).
  - Rigid metal or plastic cylinder.
- **Facepiece Assembly**:
  - Flexible **[Natural Rubber](/en/materials/natural-rubber)** sheet or soft leather for the mask skirt.
  - Transparent **[Glass](/en/materials/glass)** or clear plastic for eye lenses.
  - Elastic head straps.
