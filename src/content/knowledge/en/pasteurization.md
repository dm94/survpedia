...
1.  **Heating:** The liquid is heated to a specific temperature (below its boiling point).
2.  **Holding:** It is held at that temperature for a precise duration.
3.  **Cooling:** It is rapidly cooled to prevent any surviving spores from multiplying.
...
1.  **Preparation:** Place the liquid (e.g., raw milk) in a clean **[Container](/en/inventions/containers)**.
2.  **Heating:** Place the container in a water bath (to ensure even heating and prevent scorching).
3.  **Monitoring:** Use a **[Thermometer](/en/inventions/thermometer)** to reach the target temperature (63°C for small batches).
4.  **Holding:** Maintain the temperature steadily for 30 minutes.
5.  **Cooling:** Place the container in an ice bath or cold water to lower the temperature quickly to below 4°C (40°F).
6.  **Storage:** Keep refrigerated in a sealed container.

Technical level: Intermediate. Requires accurate temperature measurement.

## Materials needed

- **Essential:** Liquid to be treated, **[Water](/en/materials/water)** for the heating bath.
- **Tools:** **[Containers](/en/inventions/containers)** (pots, bottles), **[Thermometer](/en/inventions/thermometer)**, heat source.
