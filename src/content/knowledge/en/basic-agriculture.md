...
relatedMaterials: ["wood", "stone", "plant-fibers", "water"]
---
...
1. **Soil preparation:** Clearing land and loosening soil to facilitate root growth.
2. **Sowing:** Placing seeds at the correct depth and spacing.
3. **Maintenance:** Protecting plants from competitors (weeds) and pests.
4. **Harvesting:** Collecting the useful parts of the plant at maturity.

## How to create it

The most basic form of agriculture (horticulture) requires:
1. **Cleared land:** Use of fire or tools to remove wild vegetation.
2. **Digging tool:** A simple pointed stick (digging stick) to make holes for seeds or tubers.
3. **Water source:** Dependence on rainfall or proximity to rivers/lakes.
4. **Seed selection:** Saving the best seeds from one harvest for the next planting.
...
- **Industrial agriculture:** Use of machinery, **[Synthetic Fertilizer](/en/materials/synthetic-fertilizer)**, and genetic engineering.
