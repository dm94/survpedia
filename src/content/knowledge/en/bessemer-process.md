...
1. **Oxidation**: Air is blown through the bottom of a pear-shaped vessel (the Bessemer converter) containing molten pig iron.
2. **Exothermic Reaction**: The oxygen in the air reacts with the silicon and manganese, then with the carbon. These reactions release heat, keeping the metal molten without extra fuel.
3. **Decarburization**: Carbon is burnt off as carbon monoxide.
4. **Recarburization**: Once impurities are removed, a precise amount of carbon and manganese (often as spiegeleisen) is added back to achieve the desired steel properties.

## How to implement

### 1. The Converter
- Build a large, pear-shaped steel vessel lined with refractory **[Clay](/en/materials/clay)** or **[Silica](/en/materials/sand)** (acid process) or **[Limestone](/en/materials/limestone)**/**Dolomite** (basic process, for high-phosphorus iron).
...
### 3. The Blow
- Charge the converter with molten **[Pig Iron](/en/materials/pig-iron)** from a **[Blast Furnace](/en/inventions/blast-furnace)**.
...
- **Fluxes**: **[Limestone](/en/materials/limestone)** to remove phosphorus and form slag.
