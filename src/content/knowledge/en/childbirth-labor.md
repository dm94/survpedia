...
1. **Prepare a clean space**: Wash hands, surfaces, and cloths; set warm wraps.
2. **Support positioning**: Use upright or side positions; avoid prolonged flat lying.
3. **Manage pace**: Encourage breathing, hydration, and short rests.
4. **Protect tissues**: Apply gentle support as the head crowns; do not force.
5. **Monitor continuously**: Track contraction rhythm, bleeding, and maternal alertness.
6. **Plan for escalation**: Know when to call trained help or transfer.
...
- **Essential hygiene**: **[Water](/en/materials/water)**, **[Soap](/en/materials/soap)**, **[Cotton](/en/materials/cotton)**, **[Fabric](/en/materials/fabric)**.
- **Support and comfort**: **[Wood](/en/materials/wood)** for a stool or bench, warm cloths, clean wraps.
- **Hygiene tools**: **[Alcohol](/en/materials/alcohol)** for surface cleaning when available.
- **Emergency ties**: **[Surgical Thread](/en/materials/surgical-thread)** or **[Plant Fibers](/en/materials/plant-fibers)** for clean ties.
- **Skin protection**: **[Beeswax](/en/materials/beeswax)** or **[Animal Fat](/en/materials/animal-fat)** in small amounts for gentle protective salves.
