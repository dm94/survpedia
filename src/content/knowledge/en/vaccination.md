...
1. **Plan priorities**: Define target groups and contraindications based on risk.
2. **Secure supply**: Verify vaccine type, storage needs, and expiry.
3. **Set cold storage**: Use shaded storage or a **[Zeer Pot](/en/inventions/zeer-pot)** when electricity is unavailable.
4. **Prepare a clean area**: Organize flow, hand hygiene, and safe disposal.
5. **Deliver doses**: Trained staff administer with clean technique and **[Needles](/en/inventions/needle)**.
6. **Observe and support**: Monitor for immediate reactions and provide guidance.
7. **Record and follow up**: Track doses and schedule boosters.
...
- **Hygiene**: **[Water](/en/materials/water)**, **[Alcohol](/en/materials/alcohol)**, **[Cotton](/en/materials/cotton)**.
- **Delivery**: **[Needles](/en/inventions/needle)** and clean **[Containers](/en/inventions/containers)** for supplies and disposal.
- **Storage**: **[Glass](/en/materials/glass)** vials and cool storage such as a **[Zeer Pot](/en/inventions/zeer-pot)**.
- **Tool materials**: **[Steel](/en/materials/steel)** for durable instruments.
...
- **[How to manage an epidemic](/en/knowledge/epidemic-management)**: Integrated outbreak control.
- **[Antigens](/en/knowledge/antigens)**: Immune targets used in vaccines.
- **[Needle](/en/inventions/needle)**: Delivery tool.
- **[Alcohol](/en/materials/alcohol)**: Antiseptic for skin and tools.
- **[Glass](/en/materials/glass)**: Vials and sterile handling.
