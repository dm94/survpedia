...
1.  **Variation**: Recognizing that individuals within a population have different traits (e.g., some wheat stalks have larger seeds).
2.  **Selection**: Choosing individuals with the most desirable traits to be the parents of the next generation.
3.  **Inheritance**: The offspring inherit the genetic basis for those desirable traits.
4.  **Repetition**: Over many generations, the desired trait becomes dominant in the population.

## How to implement it

1.  **Identify Goals**: Determine which trait is most needed (e.g., drought resistance in **[Wheat](/en/materials/wheat)**).
2.  **Observe and Screen**: Closely monitor the current population to find individuals that naturally exhibit the trait.
3.  **Isolation**: Prevent selected individuals from breeding with the general population (to avoid "diluting" the trait).
4.  **Controlled Mating**: For animals, physically bring the chosen pair together. For plants, use hand-pollination or isolated plots.
5.  **Progeny Testing**: Evaluate the offspring. If they show the trait, continue breeding them. If not, return to step 2.

## Materials needed

- **Genetic Stock**: A large enough population of the species to ensure natural variation.
- **Record Keeping**: Tools to track lineages (clay tablets, **[Paper](/en/materials/paper)**, or even simple notches on wood).
- **Physical Barriers**: Fences for **[Livestock](/en/knowledge/livestock)** or separate plots for plants to prevent unintended cross-breeding.
