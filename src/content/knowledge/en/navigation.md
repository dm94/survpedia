...
1.  **Direction**: Determined using a **[Compass](/en/inventions/compass)**, which aligns with the Earth's magnetic field (often utilizing **[Magnetite](/en/materials/magnetite)**), or by observing the stars and sun.
2.  **Latitude**: Determined by measuring the angle of celestial bodies (like the North Star or the midday Sun) above the horizon using a **[Sextant](/en/inventions/sextant)**.
3.  **Longitude**: Historically the most difficult to determine. It requires knowing the exact time at a reference point (Prime Meridian) and comparing it to the local time. A highly accurate **[Chronometer](/en/inventions/chronometer)** is essential for this.
4.  **Dead Reckoning**: Estimating current position based on a previously determined position, then advancing that position based on known or estimated speeds over elapsed time and course.
...
- **Chart Work**: Plot your course and position on a **[Map](/en/inventions/map)** using a **[Drawing Compass](/en/inventions/drawing-compass)** and **[Ruler](/en/inventions/ruler)**.

## Materials needed

- **Reference**: Nautical almanacs and charts (on **[Paper](/en/materials/paper)**).
- **Instruments**:
  - **[Compass](/en/inventions/compass)**: For heading.
  - **[Sextant](/en/inventions/sextant)**: For measuring angles.
  - **[Chronometer](/en/inventions/chronometer)**: For precise timekeeping.
  - **[Telescope](/en/inventions/telescope)**: For sighting distant landmarks or celestial bodies.
- **Recording**: **[Ink](/en/materials/ink)** and logbooks.
