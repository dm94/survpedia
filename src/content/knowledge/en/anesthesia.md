...
1. **Assess the need**: Match the anesthesia level to the procedure and risk.
2. **Prepare the space**: Clean hands, tools, and surfaces; organize materials.
3. **Choose the safest option**: Prefer local control and minimal sedation.
4. **Use known agents only**: Avoid unknown chemicals or improvised mixtures.
5. **Monitor continuously**: Watch breathing, alertness, and skin color.
6. **Observe recovery**: Keep the person under supervision until stable.
...
- **Essential hygiene**: **[Water](/en/materials/water)**, **[Soap](/en/materials/soap)**, **[Alcohol](/en/materials/alcohol)**, **[Cotton](/en/materials/cotton)**.
- **Procedure tools**: **[Surgery Tools](/en/inventions/surgery-tools)**, **[Needle](/en/inventions/needle)**.
- **Stabilization**: **[Surgical Thread](/en/materials/surgical-thread)** or **[Plant Fibers](/en/materials/plant-fibers)** for ties and support.
...
- **[Dentistry](/en/knowledge/dentistry)**: Procedures that often need pain control.
- **[Basic Hygiene](/en/knowledge/basic-hygiene)**: Clean practices that reduce risk.
- **[Surgery Tools](/en/inventions/surgery-tools)**: The instrument set used during care.
- **[Needle](/en/inventions/needle)**: Used for delivery and suturing.
- **[Scalpel](/en/inventions/scalpel)**: Precise cutting tool requiring pain control.
- **[Dental Filling](/en/inventions/dental-filling)**: A procedure that may require anesthesia.
