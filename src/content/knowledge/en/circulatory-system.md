...
1. **Draft a map**: Draw the basic loop on **[Paper](/en/materials/paper)** with **[Ink](/en/materials/ink)** from heart → arteries → capillaries → veins.
2. **Mark key points**: Identify palpable pulses (neck, wrist, groin) and compression zones.
3. **Add clinical signals**: Capillary refill time, skin color, and heart rate.
4. **Tie to anatomy**: Use **[Anatomy & Blood](/en/knowledge/anatomy-blood)** for bony landmarks.
5. **Validate in practice**: Refine the map with real cases and record variations.

## Materials needed

- **Essential**: **[Paper](/en/materials/paper)**, **[Ink](/en/materials/ink)**, and **[Bone](/en/materials/bone)** references for landmarks.
- **Hygiene**: **[Soap](/en/materials/soap)**, **[Alcohol](/en/materials/alcohol)**, **[Cotton](/en/materials/cotton)**, **[Water](/en/materials/water)**.
- **Support**: **[Blood Type](/en/knowledge/blood-type)** records for triage and transfusion safety.
