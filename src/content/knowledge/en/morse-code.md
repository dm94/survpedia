...
3.  **Efficiency**: Common letters (like 'E') are assigned the shortest sequences (a single dot), while rare letters (like 'Q') have longer sequences.

## How to implement it

1.  **Learning the Alphabet**: Operators must memorize the sequences for each letter and number.
2.  **Transmission**: Use a key (switch) to open and close an electric circuit (telegraph) or to turn a carrier wave on and off (radio).
3.  **Reception**: Listen to the clicks or tones and transcribe them back into text.
