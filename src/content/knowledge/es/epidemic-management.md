...
Gestionar una epidemia es coordinar higiene, aislamiento, saneamiento y comunicación para cortar cadenas de contagio. El objetivo es reducir la transmisión, proteger a los vulnerables y mantener los servicios básicos sin colapsar.

## Uso / Función

- **Control de contagio**: Reduce la transmisión por contacto, superficies y aire.
- **Protección comunitaria**: Prioriza a personal de cuidado y grupos vulnerables.
- **Continuidad básica**: Mantiene agua segura, alimentos y limpieza mínima.
- **Organización social**: Define reglas claras para circulación, cuidado y aislamiento.
- **Escala**: Desde familias hasta asentamientos completos.

## Principio de funcionamiento

- **Reducción de exposición**: Menos contactos cercanos, menos riesgo.
- **Carga infecciosa menor**: Higiene constante reduce patógenos activos.
- **Barreras físicas**: Separar áreas limpias y contaminadas evita propagación.
- **Saneamiento**: Manejo seguro de residuos corta rutas fecales.
- **Ventilación**: El aire renovado diluye partículas infecciosas.
...
Básico a intermedio. La disciplina y la organización pesan más que la tecnología.
...
- **Falsa seguridad**: La higiene sin aislamiento no basta.
- **Recontaminación**: Agua segura se pierde si los recipientes no están limpios.
- **Sobrecarga social**: El aislamiento prolongado requiere apoyo psicológico y logístico.
- **Uso incorrecto de desinfectantes**: Concentraciones altas pueden irritar o quemar.

### Materiales relacionados

- **[Agua](/es/materials/water)**: Base para higiene y consumo.
