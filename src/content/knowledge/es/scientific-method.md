...
- **Llevar un registro**: Usa **[Papel](/es/materials/paper)** y **[Tinta](/es/materials/ink)** para registrar cada observación y experimento. La memoria humana es falible y sesgada.
...
- **Esencial**: Una mente curiosa y un compromiso con la honestidad.
- **Herramientas**:
  - **Registro**: **[Papel](/es/materials/paper)**, **[Tinta](/es/materials/ink)** o **[Carbón](/es/materials/charcoal)**.
  - **Medición**: **[Balanza de platillos](/es/inventions/balance-scale)** (masa), **[Regla](/es/inventions/ruler)** (longitud), **[Cronómetro](/es/inventions/chronometer)** (tiempo), **[Termómetro](/es/inventions/thermometer)** (temperatura).
  - **Observación**: **[Microscopio](/es/inventions/microscope)**, **[Telescopio](/es/inventions/telescope)**.
