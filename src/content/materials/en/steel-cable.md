...
- **Raw Materials**: High-carbon **[Steel](/en/materials/steel)**.

### Minimum processing required

1.  **Wire Drawing**: Pulling steel rods through smaller and smaller dies to create thin, strong wires.
2.  **Stranding**: Twisting several wires together to form a strand.
3.  **Closing**: Twisting several strands around a core (fiber or steel) to form the final cable.
...
- **[Chain](/en/inventions/chain)**: Heavier, less smooth operation.
- **[Rope](/en/materials/rope)** (Natural/Synthetic): Much weaker, degrades in sunlight/weather.
