...
- **Ingredients**:
  - **[Resin](/en/materials/resin)**: From pine, spruce, or fir trees.
  - **[Charcoal](/en/materials/charcoal)**: From a campfire.
  - **Plasticizer**: **[Beeswax](/en/materials/beeswax)**, **[Animal Fat](/en/materials/animal-fat)**, or tallow.
- **It is a manufactured material.**

### Minimum processing required

1.  **Collect Resin**: Gather hardened globs or fresh sap from damaged coniferous trees.
2.  **Refine Resin**: Melt the resin gently and strain out bark and insects.
3.  **Prepare Charcoal**: Grind charcoal into a very fine dust.
4.  **Mix**: Stir the charcoal dust into the melted resin (approx. 3 parts resin to 1 part charcoal).
5.  **Add Plasticizer**: Add a small amount of beeswax or fat (approx. 10-15% of total volume) to prevent brittleness.
6.  **Store**: Let it cool on a stick ("glue stick") or in a container.
...
- **[Resin](/en/materials/resin)**: The base ingredient.
- **[Charcoal](/en/materials/charcoal)**: The strengthening filler.
- **[Beeswax](/en/materials/beeswax)**: The plasticizer.
- **[Animal Fat](/en/materials/animal-fat)**: Alternative plasticizer.
- **[Glue](/en/materials/glue)**: Animal glue is an alternative for indoor use.
- **[Duct Tape](/en/materials/duct-tape)**: Uses a similar concept of adhesive on a backing.
