...
1.  **Mixing:** Grind limestone and clay together in specific proportions (approx. 4:1).
2.  **Burning:** Heat the mixture in a kiln to ~1450°C (sintering). This forms nodular lumps called "clinker".
3.  **Grinding:** Grind the clinker into a very fine powder.
4.  **Additives:** Usually mixed with a small amount of gypsum (to control setting time) during grinding.
