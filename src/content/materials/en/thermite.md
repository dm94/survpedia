...
manufacturingProcess: >-
  Mixing finely powdered aluminum with a metal oxide (usually iron oxide or
  rust) in a roughly 1:3 ratio by mass.
category: synthetic
image: ../../../assets/images/materials/thermite.jpg
---
...
- **Components**: **[Aluminium](/en/elements/aluminium)** powder and **[Iron Oxide](/en/materials/iron-oxide)** (rust).

### Minimum processing required

1.  **Powdering**: Grinding aluminum into a fine powder (e.g., from scrap or foil).
2.  **Oxide Preparation**: Gathering iron oxide (rust) and ensuring it is dry and powdered.
3.  **Mixing**: Thoroughly mixing the two powders.
4.  **Ignition**: Requires a high-temperature source like a magnesium ribbon or a specialized "igniter" mix (like potassium permanganate and glycerin).
...
- **[Aluminium](/en/elements/aluminium)**: The fuel.
- **[Iron Oxide](/en/materials/iron-oxide)**: The oxidizer.
- **[Iron](/en/elements/iron)**: The product.
