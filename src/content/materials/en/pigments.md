...
1.  **Collection**: Mining the mineral or collecting the organic source.
2.  **Grinding**: Using a mortar and pestle or mill to crush the material into a fine powder. Coarse particles make gritty paint.
3.  **Washing (Levigation)**: Mixing the powder with water to separate heavy impurities (which sink) from fine pigment particles (which stay suspended longer), then decanting.
4.  **Drying**: Removing moisture from the refined pigment paste.
...
- **[Paint](/en/materials/paint)**: The primary application of pigments (Pigment + Binder).
...
- **[Ink](/en/materials/ink)**: Pigments suspended in a liquid for writing.
- **[Glue](/en/materials/glue)**: Can act as a binder.
- **[Clay](/en/materials/clay)**: A source of earth pigments (Ochre).
