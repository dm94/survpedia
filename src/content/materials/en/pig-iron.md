...
- **Industrial Product**: It is produced at the base of a **[Blast Furnace](/en/inventions/blast-furnace)**.
...
- **Remelting**: Used in foundries to create **[Cast Iron](/en/materials/cast-iron)**.
- **Refining**: The primary feedstock for the **[Bessemer Process](/en/knowledge/bessemer-process)** to create **[Steel](/en/materials/steel)**.
...
- **[Iron](/en/materials/iron)**: The base element.
- **[Charcoal](/en/materials/charcoal)**: Common fuel and carbon source.
- **[Limestone](/en/materials/limestone)**: Used as a flux to remove impurities.
- **[Steel](/en/materials/steel)**: The refined version of pig iron.
