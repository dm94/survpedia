...
- **External Wall Insulation (EWI)**: Boards are glued/pinned to the outside of **[Brick](/en/materials/brick)** or **[Concrete](/en/materials/concrete)** walls, then rendered with **[Cement](/en/materials/cement)**.
- **Insulated Concrete Forms (ICF)**: Hollow blocks of polystyrene that are stacked and filled with **[Concrete](/en/materials/concrete)**.
- **Underfloor Insulation**: Placed under concrete slabs to prevent cold rising from the ground.

### Possible substitutes

- **[Mineral Wool](/en/materials/mineral-wool)**: Fireproof and breathable (better for timber), whereas polystyrene acts as a vapor barrier.
- **[Cork](/en/materials/cork)**: Natural rigid board alternative.
- **[Polyurethane](/en/materials/polyurethane)** (PIR/PUR): Higher insulation value per inch, but more expensive.
...
- **[Oil Refinery](/en/inventions/oil-refinery)**: Source of raw materials.
- **[Molding](/en/inventions/molding)**: Process used to shape EPS.

### Related materials

- **[Thermal Insulation](/en/materials/thermal-insulation)**: General category.
- **[Concrete](/en/materials/concrete)**: Often poured into polystyrene forms (ICF).
- **[Cement Mortar](/en/materials/cement-mortar)**: Used to bond and coat polystyrene boards.
- **[Brick](/en/materials/brick)**: Substrate for polystyrene insulation.
