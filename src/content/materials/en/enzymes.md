...
- **Filtration**: Remove solids using **[Fabric](/en/materials/fabric)** or fine strainers.
...
- **Containers**: Clean **[Containers](/en/inventions/containers)** for soaking and storage.
- **Filtering**: **[Fabric](/en/materials/fabric)** or sieves to clarify extracts.
...
- **Acids**: **[Vinegar](/en/materials/vinegar)** or citrus to curdle milk, with different texture.
...
- **[Curd & Cheese](/en/materials/curd-cheese)**: Enzymes drive curd formation.
- **[Cheese](/en/materials/cheese)**: Enzymes shape texture and flavor.
- **[Salt](/en/materials/salt)**: Stabilizes and preserves enzyme extracts.
- **[Water](/en/materials/water)**: Medium for extraction and dilution.
- **[Yeast](/en/materials/yeast)**: Another biological catalyst used in food processing.
