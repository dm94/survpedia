...
Nails are typically made of metal (**[Iron](/en/materials/iron)** or **[Steel](/en/materials/steel)**). They have a sharp point at one end, a slender shank, and a flattened head at the other. The shank may be smooth or have ridges (rings or spirals) to increase holding power.

## Origin and where to find it

Nails are manufactured products.

- **Hand-forged nails:** Made by heating an iron rod in a **[Forge](/en/inventions/forge)** and hammering it into shape. Identify them by their square shank and irregular head.
...
1.  **Mining & Smelting:** Obtain the metal (**[Iron](/en/materials/iron)**, **[Copper](/en/materials/copper)**).
2.  **Forming:**
...
- **[Hammer](/en/inventions/hammer):** Essential for driving nails.
- **[Pliers](/en/inventions/pliers):** For removing or bending nails.
- **[Forge](/en/inventions/forge) & [Anvil](/en/inventions/anvil):** For making nails manually.
...
- **Lashing:** Using **[Rope](/en/materials/rope)** or cordage to bind members together.
- **Screws:** Provide better holding power but are harder to make/install without modern tools.
- **[Glue](/en/materials/glue):** For smaller joints or in combination with other fasteners.
