...
1.  **Harvesting**: Collecting the plant fibers.
2.  **Spinning**: Twisting fibers into strong, thick yarn.
3.  **Weaving**: Using a loom to interlace the yarns in a simple over-under pattern (plain weave).
4.  **Priming (for Art)**: Applying a size (glue) and a ground (gesso/primer) to prevent oil paint from rotting the fabric.
