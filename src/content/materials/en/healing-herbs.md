...
title: "Healing Herbs"
properties:
  ["Medicinal", "Aromatic", "Anti-inflammatory", "Antiseptic", "Organic"]
uses:
  [
    "Herbal tea",
    "Poultice",
...
manufacturingProcess: "Harvested from wild or cultivated herbs and prepared by drying, crushing, or infusion."
category: "plant"
---
...
- **[Mortar and Pestle](/en/inventions/mortar)** for grinding.
- **[Containers](/en/inventions/containers)** for storage.

### Common forms of use

- Fresh poultice for wounds or inflammation.
- Dried infusions with **[Water](/en/materials/water)**.
- Tinctures with **[Alcohol](/en/materials/alcohol)**.
- Infused oils with **[Vegetable Oil](/en/materials/vegetable-oil)**.
- Salves using **[Beeswax](/en/materials/beeswax)** or **[Animal Fat](/en/materials/animal-fat)**.

### Possible substitutes

- Other local herbs with similar effects (anti-inflammatory, antiseptic, or soothing).
- **[Alcohol](/en/materials/alcohol)** as a disinfectant when herbs are unavailable.
...
- **[Medicinal Plants](/en/materials/medicinal-plants)**: The broader category.
- **[Simple Medicines](/en/inventions/simple-medicines)**: Processing methods for stable remedies.
- **[Water](/en/materials/water)**: Base solvent for teas.
- **[Vegetable Oil](/en/materials/vegetable-oil)**: Carrier for infused oils.
- **[Beeswax](/en/materials/beeswax)**: Thickener for salves.
