---
title: "Fertilizante sintético"
formula: "NH4NO3, (NH4)2SO4, etc."
composition: ["nitrogen", "phosphorus", "potassium"]
properties: ["Granular", "Altamente soluble", "Alto contenido de nitrógeno", "A menudo higroscópico"]
uses: ["Nutrición de cultivos", "Aumento de rendimientos agrícolas", "Agricultura industrial"]
naturalAvailability: false
manufacturingProcess: "Producido mediante la reacción del amoníaco con varios ácidos (como el ácido nítrico o sulfúrico) para crear sales ricas en nitrógeno. A menudo se agregan otros minerales como fósforo y potasio para crear fertilizantes NPK."
category: synthetic
---
...
- **Industrial:** Fabricado en grandes plantas químicas utilizando **[Amoníaco](/es/materials/ammonia)** como la fuente primaria de nitrógeno.
- **Componentes:** El nitrógeno proviene del aire a través de la **[Producción de amoníaco](/es/inventions/ammonia-production)**. El fósforo y el potasio suelen extraerse de depósitos minerales.
...
- **[Amoníaco](/es/materials/ammonia)**: El precursor de nitrógeno primario.
- **[Nitrato de potasio](/es/materials/potassium_nitrate)**: Un componente de fertilizante sintético y de origen natural.
- **[Ácido sulfúrico](/es/materials/sulfuric-acid)**: Utilizado para producir sulfato de amonio y superfosfatos.
- **[Nitrógeno](/es/elements/nitrogen)**: El nutriente clave.
