...
- **Fuente**: Debe sintetizarse a partir de otros minerales, principalmente **[Nitrato de Potasio](/es/materials/potassium_nitrate)**.

### Procesamiento mínimo requerido

1.  **Destilación (Método de Glauber)**:
    - Mezclar **[Nitrato de Potasio](/es/materials/potassium_nitrate)** con **[Ácido Sulfúrico](/es/materials/sulfuric-acid)** concentrado en una retorta de vidrio.
    - Calentar suavemente la mezcla.
    - Los vapores de ácido nítrico se destilarán y pueden condensarse en un matraz receptor.
2.  **Proceso de Ostwald (Moderno)**:
    - Oxidación catalítica del **[Amoníaco](/es/materials/ammonia)** (requiere catalizador de platino y altas temperaturas).

### Herramientas necesarias para trabajar con él

- **Retorta y Receptor de Vidrio**: Esencial ya que el ácido nítrico corroe la mayoría de los metales. Requiere **[Vidrio](/es/materials/glass)**.
...
- **[Ácido Sulfúrico](/es/materials/sulfuric-acid)**: Para algunas tareas de grabado o limpieza, pero no puede realizar la nitración.
...
- **[Nitrato de Potasio](/es/materials/potassium_nitrate)**: La materia prima tradicional.
- **[Ácido Sulfúrico](/es/materials/sulfuric-acid)**: Requerido para el proceso de destilación.
- **[Amoníaco](/es/materials/ammonia)**: Precursor moderno.
- **[Plata](/es/materials/silver)**: Disuelta por el ácido nítrico para la fotografía.
