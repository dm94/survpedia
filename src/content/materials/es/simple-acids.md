...
properties: ["Corrosivo", "Olor agrio fuerte", "Líquido (o cristales si es muy puro)", "Disolvente de metales"]
uses: ["Disolver metales", "Hacer pigmentos", "Síntesis química", "Limpiador fuerte", "Cauterización médica"]
...
- **Aparato de [Destilación](/es/inventions/distillation)**: Para el método de calor (retorta de vidrio o cerámica).
- **Botellas de almacenamiento**: Vidrio o cerámica con sellos herméticos.

### Formas comunes de uso

- **Disolvente**: Disolver [Cobre](/es/materials/copper) para hacer [Cardenillo](/es/materials/verdigris) (pigmento) o [Plomo](/es/materials/lead) para hacer [Albayalde](/es/materials/white-lead) (pigmento).
- **Limpieza**: Eliminación de óxido pesado o incrustaciones.
- **Medicina**: Cauterización de heridas (histórico).

### Posibles sustitutos

- **[Ácido Sulfúrico](/es/materials/sulfuric-acid)**: Mucho más fuerte, pero más difícil de hacer.
